...
`docker run --rm -itd -v $(pwd)/nmp-cache:/src/app/nmp-cache -p 25566 -p 3000-3001 --name mineflayer-auto-shepherd mineflayer-auto-shepherd`
`docker run --rm -it -v $(pwd)/nmp-cache:/src/app/nmp-cache -p 25566 -p 3000-3001 --name mineflayer-auto-shepherd mineflayer-auto-shepherd`
